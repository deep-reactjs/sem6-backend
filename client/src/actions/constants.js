...
export const FETCH_PRODUCTS_BY_USER = "FETCH_PRODUCT_USER";

export const ALL_CATEGORIES = "ALL_CATEGORIES";
export const UPDATE_CATEGORY = "UPDATE_CATEGORY";
export const DELETE_CATEGORY = "DELETE_CATEGORY";
export const ADD_NEW_CATEGORY = "ADD_NEW_CATEGORY";
export const FETCH_CATEGORIES_BY_USER = "FETCH_CATEGORIES_USER";
...
export const FETCH_SUBCATEGORIES_BY_USER = "FETCH_SUBCATEGORIES_USER";
